...
- [ ] **Phase 1: Foundation + Live Skeleton** — Astro 6 / Tailwind v4 / Vercel deploy with security headers, CI guardrails, layouts, constants, and a placeholder homepage live at scopalfirm.com
...
Plans:
**Wave 1**
- [ ] 01-01-PLAN.md — Bootstrap Astro 6 + Tailwind v4 + Vercel adapter; placeholder homepage builds locally
...
- [ ] 01-05-PLAN.md — Push to GitHub, link Vercel project, DNS cutover for scopalfirm.com, verify all six security headers live; deploy notes + follow-up TODOs
**UI hint:** yes
...
|-------|----------------|--------|-----------|
| 1. Foundation + Live Skeleton | 0/5 | Not started | — |
